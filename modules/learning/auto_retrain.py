# modules/learning/auto_retrain.py
  ...
  def auto_retrain(force=False, model_type="gboost", optimize=False, api_mode=False):
      # Skip retraining in API mode unless explicitly forced
      if api_mode and not force:
          logger.info("🚫 API mode: Skipping auto-retraining to use pre-trained models")
          return
