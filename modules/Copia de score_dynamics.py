...
def score_combinations(
    ...
    core_set: Optional[Set[int]] = None  # NEW: Optional core set parameter
) -> List[Dict[str, Any]]:
    """
    ...
    if filtro and rows > 0:
        try:
            ...
            historical_scores = Parallel(n_jobs=-1)(delayed(calc_score)(row) for row in historial.values[-100:])
