...
from core.consensus_engine import validate_combination  # Import shared validation
            ...
            for i in range(max_seeds * 4):  # Increased for more attempts
                ...
                with torch.no_grad():
                    ...
                    for g in generated:
                        ...
                        try:
                            score_filtro, razones = filtro.aplicar_filtros(draw, return_score=True, perfil_svi=perfil_filtro)
