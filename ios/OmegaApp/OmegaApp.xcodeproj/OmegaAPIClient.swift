...
// MARK: - Network Security Manager Placeholder
...
class NetworkSecurityManager {
    ...
    func createSecureRequest(for url: URL, method: HTTPMethod) -> URLRequest {
        var request = URLRequest(url: url)
        switch method {
        case .GET:
    ...
    func performSecureDataTask(with request: URLRequest) async throws -> (Data, URLResponse) {
