...
class NetworkSecurityManager: NSObject, ObservableObject {
    ...
    private func validateResponseSecurity(_ response: URLResponse) throws {
        ...
        if !missingHeaders.isEmpty && AppConfig.currentEnvironment == .production {
            AppLogger.shared.warning("Response missing security headers", category: .security, metadata: [
...
struct SecurityAlert: Identifiable, Equatable {
    ...
    enum Severity: String, CaseIterable {
        ...
        var logLevel: AppLogger.LogLevel {
            switch self {
            case .info:
                return .info
            case .warning:
