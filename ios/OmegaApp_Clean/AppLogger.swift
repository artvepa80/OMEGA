...
class AppLogger {
    ...
    func warning(
        ...
        log(level: .info, message: message, category: category, file: file, function: function, line: line, metadata: combinedMetadata)
    }
    ...
    func error(
        ...
        log(level: .error, message: message, category: category, file: file, function: function, line: line, metadata: combinedMetadata)
    }
